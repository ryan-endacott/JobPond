...
if Rails.env.development?
  ...
  100.times do
    ...
    ee = Employee.find_or_create_by_email(
    ...
    ee.build_resume(
      address: "999 N. Some Address Avenue",
      city: "My City",
      state: "California",
      zipcode: 99999,
      ...
      graduation_date: "",
      birthday: "",
      job_experiences_attributes: [
        { company: "Taco Bell", time: "1 month", title: "Cook" },
        { company: "Wendy's", time: "1 month", title: "Cook" }
      ],
      references_attributes: [
        { email: "some@email.com", length_known: "Too Long", name: "John Doe", phone_number: "777-777-7777", relationship: "Relative" },
        { email: "someother@email.com", length_known: "Too Long", name: "John Deer", phone_number: "777-777-7777", relationship: "Relative" }
      ]
    ).save
